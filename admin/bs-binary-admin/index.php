    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">SALAM'S STORE</a>
            </div>
...
font-size: 16px;">
                Last access :
                <?php
                // Atur timezone sesuai lokasi
                date_default_timezone_set('Asia/Jakarta');

                // Simpan waktu login ke session saat user berhasil login
